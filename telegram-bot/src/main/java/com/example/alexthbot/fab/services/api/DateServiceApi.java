...
public class DateServiceApi implements DateService {
    ...
    public List<Shift> getData(Long id) {
        ...
        ResponseEntity<List<Shift>> proceduresEntity = new RestTemplate().exchange("${gateway.host}/patient/doctor/" + id + "/shifts", HttpMethod.GET, httpEntity, CollectionParams.get());
